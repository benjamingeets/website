...
import {
  ...
  UnoGenerator,
  type UserConfig,
} from "https://esm.sh/@unocss/core@0.38.1";
import presetWind from "https://esm.sh/@unocss/preset-wind@0.38.1?bundle&no-check";
...
function Html({
  ...
  return (
    <html lang={lang ?? "en"} class={dark ? "dark" : undefined}>
      ...
      <script defer data-domain="geets.dev" src="https://plausible.io/js/plausible.js"></script>
        <meta charSet="utf-8" />
