<template>
  <nuxt-link :to="'/blog/' + slug" class="w-80 mx-2 bg-gray-100 rounded-md mb-10 hover:shadow-md transition duration-300">
    ...
    <div class="bg-gray-100 px-4 py-4 rounded-b-md ">
      ...
      <p class="my-4 text-sm h-full" :title="description">{{ description }}</p>
