<template>
    <div :class="'flex mt-4 ' + justify">
          ...
          <li :class="liStyle" title="CV"><a href="https://www.notion.so/geets/Benjamin-Geets-c2a4ba73fd674488a636ddc3d1a784df" target="_blank"><CV :class="iconStyle" :size="size" :color="color"/></a></li>
        </ul>
        </div>
</template>
