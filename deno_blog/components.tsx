      ...
      <article>
        ...
        <p class="mt-1 text-gray-500">
          {(state.author || post.author) && (
            <span>
              Par {state.author || post.author} le {" "}
            </span>
          )}
...
function IconLoak() {
  return (
    <svg className="inline-block w-4 h-4" fill="currentColor" width="31" height="26" viewBox="0 0 31 26" xmlns="http://www.w3.org/2000/svg">
